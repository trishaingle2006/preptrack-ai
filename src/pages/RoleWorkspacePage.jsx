import { Activity, LoaderCircle, Save, Settings, ShieldCheck, UserCog, UsersRound } from "lucide-react";
...
export default function RoleWorkspacePage({ type }) {
  ...
  const [activity, setActivity] = useState({ metrics: {}, recent: [] });
  ...
  useEffect(() => {
    ...
    if (!mentor) {
      apiRequest("getAdminWorkspace").then((data) => {
        ...
        setActivity(data.activity ?? { metrics: {}, recent: [] });
